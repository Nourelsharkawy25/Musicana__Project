...
namespace Musicana.Api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Songs",
                columns: new[] { "Id", "CoverImagePath", "Description", "Duration", "FilePath", "Genre", "IsDeleted", "PlayCount", "Title" },
                values: new object[,]
                {
                    { 1, "/CoverImages/cover1.jpg", "Description 1", 0.0, "/Songs/song1.mp3", 1, false, 0, "Song 1" },
                    { 2, "/CoverImages/cover1.jpg", "Description 2", 0.0, "/Songs/song1.mp3", 0, false, 0, "Song 2" },
                    { 3, "/CoverImages/cover1.jpg", "Description 3", 0.0, "/Songs/song1.mp3", 6, false, 0, "Song 3" },
                    { 4, "/CoverImages/cover1.jpg", "Description 4", 0.0, "/Songs/song1.mp3", 4, false, 0, "Song 4" },
                    { 5, "/CoverImages/cover1.jpg", "Description 5", 0.0, "/Songs/song1.mp3", 3, false, 0, "Song 5" },
                    { 6, "/CoverImages/cover1.jpg", "Description 6", 0.0, "/Songs/song1.mp3", 1, false, 0, "Song 6" },
                    { 7, "/CoverImages/cover1.jpg", "Description 7", 0.0, "/Songs/song1.mp3", 4, false, 0, "Song 7" },
                    { 8, "/CoverImages/cover1.jpg", "Description 8", 0.0, "/Songs/song1.mp3", 2, false, 0, "Song 8" },
                    { 9, "/CoverImages/cover1.jpg", "Description 9", 0.0, "/Songs/song1.mp3", 5, false, 0, "Song 9" },
                    { 10, "/CoverImages/cover1.jpg", "Description 10", 0.0, "/Songs/song1.mp3", 1, false, 0, "Song 10" }
                });
